...
MOTION_REPORT_DESCRIPTOR: bytes = bytes(
    [
        0x06,
        0x00,
        0xFF,  # Usage Page (Vendor Specific 0xFF00)
        0x09,
        ...
        0x09,
        0x21,  #   Usage (Vendor: Gyro X)
        0x09,
        0x22,  #   Usage (Vendor: Gyro Y)
        0x09,
        0x23,  #   Usage (Vendor: Gyro Z)
        # Accelerometer X, Y, Z — int16 (linear acceleration)
        0x09,
        0x24,  #   Usage (Vendor: Accel X)
        0x09,
        0x25,  #   Usage (Vendor: Accel Y)
        0x09,
        0x26,  #   Usage (Vendor: Accel Z)
        0x16,
        0x00,
        0x80,  #   Logical Minimum (-32768)
        0x26,
